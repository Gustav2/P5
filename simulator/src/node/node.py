...
class Node:
    ...
    def soonest_sync(self, node_id=None):
        ...
        for id, neigh in self.neighbors.items():
            ...
            my_sync_time = neigh["last_meet_mine"] / drift_rate + SYNC_INTERVAL + SYNC_TIME / 2 # reverted to fit report
    ...
    def get_upcoming_sync_nodes(self):
        ...
        for node_id, neigh in self.neighbors.items():
            ...
            if soonest - SYNC_TIME/2 <= meet_in <= soonest + SYNC_TIME/2: # reverted to fit report
