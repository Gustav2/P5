...
NODES = 100 # Amount of nodes in the simulation
SIM_TIME = 86_400 # Simulation time in seconds
...
CLOCK_DRIFT_RANGE = (-0.05, 0.05) # Range for a clock drift
WAKEUP_POINT_TRESHOLD = 60 # Wake up before meeting for half of this amount of seconds and go to sleep after another half
MEETUP_INTERVAL = 120 # Amount of seconds to have meeting point at
WAKEUP_RANGE = (200, 250) # Range for random wake up if device has no discoveries yet
