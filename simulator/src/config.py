...
SIM_TIME = 50 * ONE_DAY # Simulation time in seconds
SUNRISE_TIME, SUNSET_TIME = 8 * 24 * 60, 18 * 24 * 60 # Time of sunrise and sunset in seconds
...
MEETUP_INTERVAL = 7 * ONE_DAY # Amount of seconds to have meeting point at
WAKEUP_RANGE = (300, 600) # Range for random wake up if device has no discoveries yet
SYNC_TRESHOLD = 60 # Time used to check if devices just synced or discovered each other
