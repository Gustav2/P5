...
if __name__ == "__main__":
    ...
    print(f"Standby Energy: {energy_standby:.2f} mJ ({Tstandby:.3f} s)")
    print(f"Idle Energy: {energy_idle:.2f} mJ ({Tidle:.3f} s)")
    print(f"Standby Energy (J): {energy_standby/1000:.2f}")
    print(f"Idle Energy (J): {energy_idle/1000:.2f}")
